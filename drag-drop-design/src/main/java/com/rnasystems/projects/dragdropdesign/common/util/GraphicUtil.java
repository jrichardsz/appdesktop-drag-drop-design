...
public class GraphicUtil {
    ...
    public static boolean estaDentro(JComponent container, JComponent component) {
...
//        
    ...
    public static void drawEjes(Graphics2D g2d, int x_ini, int y_ini) {
    ...
    public static void drawDashedEjes(Graphics2D g2d, int x_ini, int y_ini) {
    ...
    public static void drawDashedEjes(Graphics2D g2d, int x_ini, int y_ini,Color c1x, Color c2x,Color c1y, Color c2y) {
    ...
    public static void drawDashedEjeX(Graphics2D g2d, int x_ini, int y_ini, Color c1, Color c2) {
    ...
    public static void drawDashedEjeY(Graphics2D g2d, int x_ini, int y_ini, Color c1, Color c2) {
